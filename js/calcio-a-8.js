...
// ===============================
// HELPER: verifica calcio a 8 / calciotto
// ===============================
function isCalcioA8(sportRaw) {
  const sport = normalizeSport(sportRaw);

  const isFootball = sport.includes("calcio") || sport.includes("calciotto");

  const isEight =
    sport.includes("8") ||
    sport.includes("a 8") ||
    sport.includes("otto") ||
    sport.includes("calciotto");

  return isFootball && isEight;
}
