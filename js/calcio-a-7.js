...
// ===============================
// HELPER: verifica calcio a 7
// ===============================
function isCalcioA7(sportRaw) {
  ...
  const isSeven =
    sport.includes("7") ||
    sport.includes("a 7") ||
    sport.includes("sette");

  return isFootball && isSeven;
}
...
function renderTournaments(tournaments) {
  ...
  if (tournaments.length === 0) {
    container.innerHTML = "<p class='placeholder'>Nessun torneo di calcio a 7 disponibile al momento.</p>";
    return;
  }
